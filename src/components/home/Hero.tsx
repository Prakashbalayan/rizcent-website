      ...
      <div className="rz-hero-container">
        ...
        <div className="rz-hero-copy">
          ...
          <p className="rz-hero-description">
            Rizcent Technologies builds modern digital
            products and helps businesses protect their
            technology with practical, security-first
            solutions.
          </p>
          ...
          <div className="rz-hero-actions">
            ...
            >
              ...
              <span className="rz-button-content">
                <span className="rz-button-label">
                  Get Started
                </span>

                <span className="rz-button-arrow">
                  →
                </span>
              </span>
            </Link>
          ...
          <div className="rz-hero-trust">
            ...
            <div className="rz-trust-mini">
              <span className="rz-trust-mini-icon">
                ✓
              </span>
        ...
        {/* =====================================================
            RIGHT SIDE — LIVE 3D TECHNOLOGY UI
        ===================================================== */}
        ...
        <div className="rz-hero-visual">
          ...
          <div className="rz-core">
            ...
            <div className="rz-core-face">
              ...
              <div className="rz-core-company">
                Rizcent
              </div>

              <div className="rz-core-subtitle">
                SECURE TECHNOLOGY
              </div>
          ...
          <div className="rz-floating-card rz-security-card">
            ...
            <div className="rz-security-content">
              ...
              <div className="rz-security-icon">
                ✓
              </div>
          ...
          <div className="rz-floating-card rz-engineering-card">
            ...
            <div className="rz-engineering-main">
              ...
              <div className="rz-engineering-icon">
                ↗
              </div>
